...
export async function createChatController(req) {
    ...
    try {
        ...
        if (req.body.message && req.body.message.trim() !== "") {
            ...
            await query(`INSERT INTO messages (id, chat_id, property_id, room_number, sender_id, content, attachments, created_at, updated_at)
