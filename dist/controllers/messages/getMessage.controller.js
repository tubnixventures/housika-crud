import { getMessageModel } from "../../models/messages/getMessage.model.js";
import { verifyToken } from "../../utils/jwt.js";
import { getSession } from "../../utils/redis.js";
import { normalizeResult } from "../../utils/normalizeResult.js";
export async function getMessageController(req) {
    ...
    const result = await getMessageModel(req.params.id);
