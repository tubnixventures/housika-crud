...
export async function createBookingController(req) {
    ...
    try {
        ...
        await query(`INSERT INTO receipts (id, receipt_number, user_id, property_id, room_number, booking_id, payment_id, amount, currency, verification_status, created_at, updated_at)
