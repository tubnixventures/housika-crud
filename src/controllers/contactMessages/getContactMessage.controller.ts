import { getContactMessageModel } from "../../models/contactMessages/getContactMessage.model.js";
import { verifyToken } from "../../utils/jwt.js";
import { getSession } from "../../utils/redis.js";
import { normalizeResult } from "../../utils/normalizeResult.js";

export async function getContactMessageController(req: any) {
  ...
  const result = await getContactMessageModel(req.params.id);
