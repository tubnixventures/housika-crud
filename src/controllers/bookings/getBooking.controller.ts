import { getBookingModel } from "../../models/bookings/getBooking.model.js";
import { verifyToken } from "../../utils/jwt.js";
import { getSession } from "../../utils/redis.js";
import { normalizeResult } from "../../utils/normalizeResult.js";

export async function getBookingController(req: any) {
  ...
  const result = await getBookingModel(req.params.id);
