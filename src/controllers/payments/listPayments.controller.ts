import { listPaymentsModel } from "../../models/payments/listPayments.model.js";
import { verifyToken } from "../../utils/jwt.js";
import { getSession } from "../../utils/redis.js";
import { normalizeResult } from "../../utils/normalizeResult.js";

export async function listPaymentsController(req: any) {
  ...
  const result = await listPaymentsModel(30);
